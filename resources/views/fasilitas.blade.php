...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
    ...
    <div class="w3-left w3-hide-small">
      <a href="{{ url('/fasillitas') }}" class="w3-bar-item w3-button">fasilitas</a>
...
<div class="w3-content" style="max-width:1100px">
  ...
  <div class="w3-row w3-padding-64" id="about">
    <div class="w3-col m4 w3-padding-large w3-hide-small">
     <img src="{{ asset('sneat') }}/assets/img/gambar/fasilitas.png" class="w3-round w3-image w3-opacity-min" alt="Table Setting" style="width: 700px; height: 400px;">
    </div>

    <div class="w3-col m8 w3-padding-large">
      <h1 class="w3-center">Fasilitas Sekolah</h1><br>
      <p class="w3-large">
        <ul>
  ...
  <div class="w3-row w3-padding-64" id="menu">
    <div class="w3-col l6 w3-padding-large">
      <h1 class="w3-center">Program Ekstra Kulikuler</h1><br>
      <h4>Program Ekskul Sekolah :</h4>
      <p class="w3-text-black">
        <ul>
            <li>Pramuka</li>
            <li>Atletik/futsal/sepakbola/volly</li>
            <li>Paskibraka</li>
            <li>UKS</li>
            <li>TIK</li>
            <li>Video Teather & karya Ilmiah remaja</li>
        </ul>
        </p>
        <br>
        <h4>Program Ekskul Pondok :</h4>
      <p class="w3-text-black">
        <ul>
            <li>Tahfidzul Qur'an</li>
            <li>Seni Bela Diri Pencak Silat ASAD</li>
            <li>Program Mubaligh/Mubalighot</li>
        </ul>
        </p>
    </div>

    <div class="w3-col l6 w3-padding-large">
      <img src="{{ asset('sneat') }}/assets/img/gambar/ekskul.jpeg" class="w3-round w3-image w3-opacity-min" alt="Menu" style="width:100%">
    </div>
  </div>
  <hr>
</div>
