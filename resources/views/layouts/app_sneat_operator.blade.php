        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Operator</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ \Route::is('user.index')?'active': '' }}">
              <a href="{{ route('user.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Data Register Siswa</div>
              </a>
            </li>
            <li class="menu-item {{ \Route::is('pendaftaransiswa.index')?'active': '' }}">
              <a href="{{ route('pendaftaransiswa.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Pendaftaran Siswa</div>
              </a>
            </li>
            <li class="menu-item {{ \Route::is('pengumumansiswa.index')?'active': '' }}">
              <a href="{{ route('pengumumansiswa.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Pengumuman Siswa</div>
              </a>
            </li>
            <li class="menu-item {{ \Route::is('jumlahpeserta.index')?'active': '' }}">
              <a href="{{ route('jumlahpeserta.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Data Jumlah Peserta Baru</div>
              </a>
            </li>
                          ...
                          <li class="list-group-item list-group-item-action dropdown-notifications-item">
                            ...
                            <div class="d-flex">
                              <div class="flex-grow-1">
                                ...
                                <p class="mb-0">{{ ucwords($notification->data['massages']) }}</p>
