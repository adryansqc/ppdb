...
.loader span:nth-child(1) {
  color: transparent;
  -webkit-text-stroke: 0.3px rgb(49, 17, 50);
}

.loader span:nth-child(2) {
  color: rgb(49, 17, 50);
  -webkit-text-stroke: 1px rgb(49, 17, 50);
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">SMA Tri Sukses</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ \Route::is('hasilpengumumansiswa.index')?'active': '' }}">
              <a href="{{ route('hasilpengumumansiswa.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
          ...
          <div class="container1 menu-item">
            <div class="content1">
              <div class="content__container">
                ...
                <ul class="content__container__list">
                  <li class="content__container__list__item">Selamat</li>
                  <li class="content__container__list__item">Datang</li>
                  <li class="content__container__list__item">Calon</li>
                  <li class="content__container__list__item">Siswa</li>
                </ul>
              </div>
            </div>
          </div>
